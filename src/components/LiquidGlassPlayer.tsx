  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 30% 20%, rgba(255,255,255,0.14), transparent 60%), rgba(255, 255, 255, 0.07)",
          ...
          borderRadius: "26px",
          boxShadow:
            "0 8px 40px rgba(0,0,0,0.25), inset 0 0 0 1px rgba(255,255,255,0.1), inset 0 1px 0 rgba(255,255,255,0.15), 0 0 80px rgba(192,132,252,0.08)",
          padding: "14px 18px",
        }}
      >
        ...
        <div className="flex items-center gap-3.5">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: "inset 0 1px 3px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.1)",
                }}
              />
            </div>
            {/* Vinyl grooves */}
          ...
          <div className="flex-1 min-w-0">
            <p
              className="text-[13px] font-semibold truncate glass-text"
              style={{ color: "rgba(255,255,255,0.95)" }}
            >
              Lo-fi Dreams
            </p>
            <p
              className="text-[11px] truncate glass-text"
              ...
              {Array.from({ length: 24 }).map((_, i) => {
                ...
                return (
                  <motion.div
                    ...
                    style={{
                      background: filled
                        ? "linear-gradient(to top, #c084fc, #f472b6)"
                    ...
                    animate={
                      playing && filled
                        ...
                        : { height: `${20 + Math.sin(i * 0.6) * 30 + 30}%` }
                    }
                    transition={
                      playing && filled
                        ? {
          ...
          <div className="flex items-center gap-0.5 flex-shrink-0">
            ...
            <motion.button
              ...
              style={{
                ...
                color: "white",
                boxShadow: "0 4px 20px rgba(192,132,252,0.45)",
              }}
              whileTap={{ scale: 0.92 }}
