...
const orbs = [
  ...
  { color: "rgba(56, 189, 248, 0.25)", size: 320, x: "60%", y: "90%", duration: 21 },
];

const AnimatedBackground = () => (
  <div className="fixed inset-0 overflow-hidden" style={{ background: "linear-gradient(135deg, #0a0a1a 0%, #1a0a2e 30%, #0d1b2a 60%, #0a0a1a 100%)" }}>
    {orbs.map((orb, i) => (
      <motion.div
        key={i}
